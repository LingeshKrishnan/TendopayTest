                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('addbooks') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="bookname" name="bookname" aria-describedby="booknameHelp" placeholder="Enter Book Name">
                            </div>
                            <div class="form-group">
                                <label for="author">Author Name</label>
                                <input type="text" class="form-control" id="author" name="author" aria-describedby="authorHelp" placeholder="Enter Author Name">
                            </div>
                            <div class="form-group">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="category" class="form-control" id="category" name="category" placeholder="Select Category">
                            </div> -->
                            <button type="submit" class="btn btn-primary">Add Book</button>
                            <div class="text-center">
                                <a href="lendbooks">Lend Books</a>
                            </div>
                            <div class="text-center">
                                <a href="booksowned">View Your Books</a>
                            </div>
                        </form>
                    </div>
                </div>
